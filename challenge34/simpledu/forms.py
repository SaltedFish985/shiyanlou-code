...
class MessageForm(FlaskForm):
    message = TextAreaField('消息', validators=[Required(), Length(1, 256)])
    submit = SubmitField('提交') 

    def send_message(self):
        form_message = {'username':'System', 'text':self.message.data}
        redis.publish('chat', json.dumps(form_message))
